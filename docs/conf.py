...
htmlhelp_basename = 'GoldenHingesdoc'
...
latex_documents = [
  ('index', 'GoldenHinges.tex', u'GoldenHinges Documentation',
   u'Zulko', 'manual'),
]
...
man_pages = [
    ('index', 'GoldenHinges', u'PACKAGE_NAME Documentation',
     [u'Zulko'], 1)
]
...
texinfo_documents = [
  ('index', 'GoldenHinges', u'GoldenHinges Documentation',
   u'Zulko', 'GoldenHinges', 'One line description of project.',
   'Miscellaneous'),
]
