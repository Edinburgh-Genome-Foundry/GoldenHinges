...
latex_documents = [
    ("index", "GoldenHinges.tex", u"GoldenHinges Documentation", u"Zulko", "manual"),
]
...
man_pages = [("index", "GoldenHinges", u"PACKAGE_NAME Documentation", [u"Zulko"], 1)]
